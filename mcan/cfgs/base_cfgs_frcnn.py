...
class Cfgs(PATH):
    def __init__(self):
        ...
        self.VERSION = 'swapmix_prob=0.25'
        ...
        # No. of perturbations per object
        self.NO_OF_CHANGES = 5

        # Select random objects if matching objects are less than self.NO_OF_CHANGES
        self.ALLOW_RANDOM = True

        ## Mean and Std deviation for adding noise to faster rcnn experiment
        self.MEAN = 1
        self.STD_DEV = 1
