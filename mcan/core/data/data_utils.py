...
def ans_stat_old(stat_ans_list, ans_freq):
    ans_to_ix = {}
    ix_to_ans = {}
    ans_freq_dict = {}
...
## To be used for scene evaluate also
def proc_ans_modify(ans, ans_to_ix):
    ans_score = np.zeros(ans_to_ix.__len__(), np.float32)
    ans_prob_dict = {}

    '''
    Modifying to accomodate new answer input format
    '''
    #for ans_ in ans['answers']:
