...
from core.data.data_utils import img_feat_path_load, img_feat_load, ques_load, tokenize, ans_stat_old
from core.data.data_utils import proc_img_feat, proc_ques, proc_ans_modify
...
from core.dataloader.gqa_scene_evaluate import GQADataset
...
class DataSet(Data.Dataset):
        ...
        if self.__C.IS_GQA :
            for split in split_list:
                ...
                if split in ['val'] :
                    ...
                    GQA = GQADataset(self.__C.VAL_SCENE_GRAPH, self.__C.GQA_VOCAB, self.__C.GQA_EMBEDDING, self.__C.OBJ_MATCHING, self.__C.ATTR_MATCHING, self.ques_list, self.__C.SCENE_OBJECT_MATCHING, self.__C.NO_OF_CHANGES, self.__C.ALLOW_RANDOM)
                    if self.__C.TYPE == 'objects' : 
                        ...
                        self.iid_to_img_feat = GQA.extractembeddings_attr(self.list_images, self.iid_to_img_feat)
    ...
    #def loading(self, idx):
        ...
        if self.__C.RUN_MODE in ['train']:
            ...
            # Process answer
            ans_iter = proc_ans_modify(ans, self.ans_to_ix)
