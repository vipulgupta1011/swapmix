...
from core_scene.data.load_data_evaluate_attr import DataSet
    ...
    def eval(self, dataset, state_dict=None, valid=False):
       ...
       #     ), end='          ')
        ...
        for k in range(num_images) :
            ...
            '''
            img_feat_obj_iter_mapping -> list of features for each object
            img_feat_attr_iter_mapping -> list of features with attributes corresponding to attribute perturbations
