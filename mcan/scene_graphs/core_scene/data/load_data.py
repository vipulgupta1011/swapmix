...
from core_scene.data.data_utils import img_feat_path_load, img_feat_load, ques_load, tokenize, ans_stat, ans_stat_new
...
from core_scene.scene_graph.gqa import GQADataset
...
class DataSet(Data.Dataset):
    def __init__(self, __C):
        ...
        #self.ans_to_ix, self.ix_to_ans = ans_stat_new('core/data/answer_dict.json')
