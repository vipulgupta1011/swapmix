...
sys.path.append('/home/vipul/swapmix/mcan/scene_graphs')
from cfgs_scene.base_cfgs import Cfgs
from core_scene.exec_evaluate_obj import Execution
...
if __name__ == '__main__':
    ...
    cfg_file = "cfgs_scene/{}_model.yml".format(args.MODEL)
