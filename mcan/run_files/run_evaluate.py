...
#from cfgs.base_cfgs_scene import Cfgs
#from core.exec_scene_evaluate import Execution
...
def parse_args():
    ...
    parser.add_argument('--NOT_ALLOW_RANDOM', dest='ALLOW_RANDOM',
                      action='store_false')

    parser.add_argument('--TYPE', dest='TYPE', type=str, default='objects')

    parser.add_argument('--FEATURES', dest='FEATURES', default='frcnn', type=str)
...
if __name__ == '__main__':
    ...
    if args.FEATURES == 'frcnn' : 
        from cfgs.base_cfgs_frcnn import Cfgs
        from core.exec_frcnn_evaluate import Execution

    if args.FEATURES == 'scene_graph' :
        from cfgs.base_cfgs_scene import Cfgs
        from core.exec_scene_evaluate import Execution
