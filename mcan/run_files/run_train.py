...
# This code is a modified version of code written by Yuhao Cui https://github.com/cuiyuhao1996
# --------------------------------------------------------
import sys
sys.path.append('.')

#from cfgs.base_cfgs_frcnn import Cfgs
from core.exec_train import Execution
...
def parse_args():
    ...
    parser.add_argument('--FEATURES', dest='features',
                      help='features to be used for model training',
