...
def parse_args():
    ...
    # Debugging
    parser.add_argument('--output', type=str, default='/home/vipul/results/test')
    ...
    # Swapmix arguments
    parser.add_argument("--NO_OF_CHANGES", default=5, type=int)
    parser.add_argument("--OUTPUT_JSON", default=None)
    parser.add_argument("--NOT_ALLOW_RANDOM", dest='ALLOW_RANDOM', action='store_false')
    parser.add_argument("--CLASS", dest='CLASS', default='objects')
    parser.add_argument("--SwapMix", action='store_const', default=False, const=True)
