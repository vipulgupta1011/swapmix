...
from tasks.gqa_data_irrelevant import GQADataset, GQATorchDataset, GQAEvaluator
import pdb
    ...
    def predict_gqa(self, eval_tuple: DataTuple, dump=None):
        ...
        for i in range(num_images) :
            ...
            for ques in questions :
                ...
                n_batches = int(np.ceil(len_features/32))
                ...
                for k in range(n_batches) :
                    img_feat_iters_batch = img_feat_iters[32*k:32*(k+1)]
                    boxes_iters_batch = boxes_iters[32*k:32*(k+1)]
                    question_iters_batch = question_iters[32*k:32*(k+1)]
