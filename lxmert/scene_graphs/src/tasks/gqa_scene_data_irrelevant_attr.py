...
from gqa_scene_graph_irrelevant_attr import GQASceneDataset
...
class GQABufferLoader():
    ...
    def load_data(self, name, number):
        if name == 'train':
            scenegraphs_json = "/data/b/vipul/datasets/gqa/scene_graphs/train_sceneGraphs.json"
        else:
            scenegraphs_json = "/data/b/vipul/datasets/gqa/scene_graphs/val_sceneGraphs.json"
        key = "%s_%d" % (scenegraphs_json, number)
        vocab_json = '/data/b/vipul/datasets/gqa/gqa_vocab_taxo.json'
        embedding_json = '/data/b/vipul/datasets/gqa/attrlabel_glove_taxo.npy'
...
class GQATorchDataset(Dataset):
    ...
    def __init__(self, dataset: GQADataset):
        ...
        # loading image data
        images_list = '/data/b/vipul/datasets/gqa/images_split/val.json'
        scenegraphs_json = "/data/b/vipul/datasets/gqa/scene_graphs/val_sceneGraphs.json"
        vocab_json = '/data/b/vipul/datasets/gqa/gqa_vocab_taxo.json'
        embedding_json = '/data/b/vipul/datasets/gqa/attrlabel_glove_taxo.npy'
        obj_matching = '/data/b/vipul/datasets/gqa/matching/obj_matching.json'
        attr_matching = '/data/b/vipul/datasets/gqa/matching/attr_matching.json'
        ques_list_path = '/data/b/vipul/datasets/gqa/images_split/val_questions_new.json'
        ans_path = '/data/b/vipul/datasets/gqa/images_split/val_answers_new.json'
        object_mapping = '/data/b/vipul/datasets/gqa/scene_graphs/object_mapping.json'
        no_of_changes = 5 
        allow_random = True
